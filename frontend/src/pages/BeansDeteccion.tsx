...
function BeansDeteccion() {
  ...
  const sinHojasDetectadas = resultado?.cantidad_hojas === 0;
      ...
      <div className="w-full max-w-3xl bg-white p-8 rounded-xl shadow-2xl">
        ...
        {resultado && (
          <div className="mt-8 border-t pt-6 space-y-6 flex flex-col items-center">
            {sinHojasDetectadas ? (
              <div className="w-full rounded-xl border border-amber-200 bg-amber-50 px-6 py-5 text-center">
                <p className="mt-2 text-sm text-amber-700">
                  Verifica que la foto muestre claramente una hoja o planta de frijol e intenta de nuevo.
                </p>
              </div>
            ) : (
              <>
